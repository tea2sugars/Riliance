/*
 ...
 Source Database       : reliance

 Target Server Version : 50169
 File Encoding         : utf-8

 Date: 09/27/2013 10:35:18 AM
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8 COMMENT='Stores block settings, such as region and visibility...';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Stores contents of custom-made blocks.';
...
-- ----------------------------
--  Table structure for `cpn`
-- ----------------------------
DROP TABLE IF EXISTS `cpn`;
CREATE TABLE `cpn` (
...
-- ----------------------------
--  Table structure for `field_data_field_company_name`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_company_name`;
CREATE TABLE `field_data_field_company_name` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_company_name_value` varchar(255) DEFAULT NULL,
  `field_company_name_format` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_company_name_format` (`field_company_name_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 7 (field_company_name)';

-- ----------------------------
--  Table structure for `field_data_field_cover_image`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_cover_image`;
CREATE TABLE `field_data_field_cover_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_cover_image_fid` int(10) unsigned DEFAULT NULL COMMENT 'The file_managed.fid being referenced in this field.',
  `field_cover_image_alt` varchar(512) DEFAULT NULL COMMENT 'Alternative image text, for the image’s ’alt’ attribute.',
  `field_cover_image_title` varchar(1024) DEFAULT NULL COMMENT 'Image title text, for the image’s ’title’ attribute.',
  `field_cover_image_width` int(10) unsigned DEFAULT NULL COMMENT 'The width of the image in pixels.',
  `field_cover_image_height` int(10) unsigned DEFAULT NULL COMMENT 'The height of the image in pixels.',
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_cover_image_fid` (`field_cover_image_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 10 (field_cover_image)';

-- ----------------------------
--  Table structure for `field_data_field_date_of_article`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_date_of_article`;
CREATE TABLE `field_data_field_date_of_article` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_date_of_article_value` varchar(255) DEFAULT NULL,
  `field_date_of_article_format` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_date_of_article_format` (`field_date_of_article_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 12 (field_date_of_article)';

-- ----------------------------
--  Table structure for `field_data_field_icon`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_icon`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 8 (field_icon)';
...
-- ----------------------------
--  Table structure for `field_data_field_logo`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_logo`;
CREATE TABLE `field_data_field_logo` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 6 (field_logo)';
...
CREATE TABLE `field_data_field_privacy` (
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_privacy_value` longtext,
  `field_privacy_format` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_privacy_format` (`field_privacy_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 11 (field_privacy)';

-- ----------------------------
--  Table structure for `field_data_field_video`
-- ----------------------------
DROP TABLE IF EXISTS `field_data_field_video`;
CREATE TABLE `field_data_field_video` (
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 9 (field_video)';
...
-- ----------------------------
--  Table structure for `field_revision_field_company_name`
-- ----------------------------
DROP TABLE IF EXISTS `field_revision_field_company_name`;
CREATE TABLE `field_revision_field_company_name` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_company_name_format` (`field_company_name_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 7 (field_company_name)';

-- ----------------------------
--  Table structure for `field_revision_field_cover_image`
-- ----------------------------
DROP TABLE IF EXISTS `field_revision_field_cover_image`;
CREATE TABLE `field_revision_field_cover_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_cover_image_fid` (`field_cover_image_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 10 (field_cover_image)';

-- ----------------------------
--  Table structure for `field_revision_field_date_of_article`
-- ----------------------------
DROP TABLE IF EXISTS `field_revision_field_date_of_article`;
CREATE TABLE `field_revision_field_date_of_article` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_date_of_article_format` (`field_date_of_article_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 12 (field_date_of...';

-- ----------------------------
--  Table structure for `field_revision_field_icon`
-- ----------------------------
DROP TABLE IF EXISTS `field_revision_field_icon`;
CREATE TABLE `field_revision_field_icon` (
  ...
  KEY `language` (`language`),
  KEY `field_icon_fid` (`field_icon_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 8 (field_icon)';
...
-- ----------------------------
--  Table structure for `field_revision_field_logo`
-- ----------------------------
...
CREATE TABLE `field_revision_field_logo` (
  ...
  KEY `language` (`language`),
  KEY `field_logo_fid` (`field_logo_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 6 (field_logo)';
...
CREATE TABLE `field_revision_field_privacy` (
  ...
  KEY `language` (`language`),
  KEY `field_privacy_format` (`field_privacy_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 11 (field_privacy)';

-- ----------------------------
--  Table structure for `field_revision_field_video`
-- ----------------------------
DROP TABLE IF EXISTS `field_revision_field_video`;
CREATE TABLE `field_revision_field_video` (
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 9 (field_video)';
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='Stores information for uploaded files.';
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='Flood controls the threshold of events, such as the...';
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='The base table for nodes.';
...
CREATE TABLE `node_revision` (
  ...
  KEY `nid` (`nid`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='Stores information about each saved version of a node.';
...
CREATE TABLE `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB AUTO_INCREMENT=1910 DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.';
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='A list of URL aliases for Drupal paths; a user may visit...';
...
-- ----------------------------
--  Table structure for `vef_video_styles`
-- ----------------------------
DROP TABLE IF EXISTS `vef_video_styles`;
CREATE TABLE `vef_video_styles` (
  `vsid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a video style.',
  `name` varchar(255) NOT NULL COMMENT 'The style name.',
  `data` longblob NOT NULL COMMENT 'The configuration data for the style.',
  PRIMARY KEY (`vsid`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Stores video embed styles.';
...
CREATE TABLE `views_view` (
  ...
  PRIMARY KEY (`vid`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Stores the general data for a view.';
...
) ENGINE=InnoDB AUTO_INCREMENT=5974 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
...
CREATE TABLE `webform_submissions` (
  ...
  KEY `nid_sid` (`nid`,`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='Holds general information about submissions outside of...';
