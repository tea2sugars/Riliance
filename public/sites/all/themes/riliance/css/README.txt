...
To use these stylesheets, rename the files and riliance with the name of your theme.
...
riliance-alpha-default-narrow.css  
...
riliance-alpha-default-normal.css
...
riliance-alpha-default-wide.css
